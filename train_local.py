...
from loss_local import FocalLoss
...
#t.set_description('loc_loss: %.3f|cls_loss: %.3f|iw: %.2f | train_loss: %.3f | avg_loss: %.3f, %d' % (loc_loss, cls_loss, iw, loss.data[0], train_loss/(batch_idx+1),flip[0]))
    ...
    if test_loss < best_loss:
        ...
        torch.save(net, './checkpoint/adam_e4_iou45_pre_fpn50_head_b2_50_nd_9ma_s20_105_5ges_6l.pkl' )
        best_loss = test_loss
...
for epoch in range(start_epoch, start_epoch+50):
    ...
    with open('/group/proteindl/ps793/Dota/retina/train_loss_e4_head_adam_nd_9ma_iou45_b2_fpn50_s20_105_5ges_6l.csv', 'wb') as myfile:
    	wr = csv.writer(myfile, quoting=csv.QUOTE_ALL)
    	wr.writerow(train_loss_list)

    with open('/group/proteindl/ps793/Dota/retina/test_loss_e4_head_adam_nd_9ma_iou45_b2_fpn50_s20_105_5ges_6l.csv', 'wb') as myfile:
    	wr = csv.writer(myfile, quoting=csv.QUOTE_ALL)
    	wr.writerow(test_loss_list)
    if epoch % 5 ==0:
       torch.save(net, './checkpoint/adam_e4_iou45_pre_fpn50_head_b2_dota_50_nd_9ma_s20_105_5ges_6l_epoch_%d.pkl' % epoch )

torch.save(net, './checkpoint/adam_e4_iou45_pre_fpn50_head_b2_dota_50_nd_9ma_s20_105_5ges_6l_final.pkl' )   
